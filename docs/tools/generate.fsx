...
let website = "/NUnit.ManualTest"

let githubLink = "http://github.com/SVogelsang/NUnit.ManualTest"

// Specify more information about your project
let info =
  [ "project-name", "NUnit.ManualTest"
    "project-author", "Stefan Vogelsang"
    "project-summary", "NUnit.ManualTest is designed to include manual tests in the NUnit Framework infrastructure."
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/NUnit.ManualTest" ]
...
let buildReference () =
  ...
  MetadataFormat.Generate
    ( binaries, output @@ "reference", layoutRootsAll.["en"],
      ...
      publicOnly = false,libDirs = libDirs, markDownComments = false)
