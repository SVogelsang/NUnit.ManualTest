...
<div class="row">
  ...
  <div class="span6">
    <div class="well well-small" id="nuget">
      The NUnit.ManualTest library can be <a href="https://nuget.org/packages/NUnit.ManualTest">installed from NuGet</a>:
      <pre>PM> Install-Package NUnit.ManualTest</pre>
    </div>
  </div>
  <div class="span1"></div>
</div>
